          ...
          <div class="col-12">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title"><a href="{{ route('petugas.create') }}" class="btn btn-success">Create</a></span></h5>
                        ...
                        <td>
                            <div class="dropup-center dropup">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('petugas.edit', $item->id) }}"</a>Edit</li>
